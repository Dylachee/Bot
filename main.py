...
token = '5603631989:AAFcUgNttb98J9w85-BTSKgJzVrzvg4zNTQ'
...
def first_message(message: types.Message):
    ...
    keyboard.add(button)
    bot.send_message(message.chat.id, 'нажми на новости чтобы получить список новостей', reply_markup=keyboard)
...
@bot.callback_query_handler(func=lambda callback: callback.data == 'Выйти')
